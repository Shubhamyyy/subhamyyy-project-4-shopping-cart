    ...
    <div>
      {
        cart.length > 0 ?
        (
        <div className="flex gap-16 max-w-5xl p-6 mx-auto flex-wrap lg:flex-nowrap">
          ...
          <div className="md:w-[30%] w-full flex flex-col gap-8 justify-between">
            <div className="mt-20">
              ...
              <div className="text-3xl font-[600] text-[#15803d] uppercase mb-4">Summary</div>
            ...
            <div className="mb-20">
              <p className="text-slate-700 text-xl font-[600] mb-5 ">Total Amount:
                <span className="font-bold ml-2 text-black">${totalAmount}</span> </p>
              <button className="text-lg w-full py-2.5 rounded-lg font-bold text-white bg-[#15803d]
          border-2 border-[#15803d] hover:bg-white hover:text-[#15803d] transition-all duration-300 ease-in">Check Out Now</button>
            </div>
          </div>
